...
using RentalKendaraan_071.Models;

namespace RentalKendaraan_071.Controllers
{
    public class PeminjamenController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdPeminjaman,TgiPeminjaman,IdKendaraan,IdCustomer,IdJaminan,Biaya")] Peminjaman peminjaman)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPeminjaman,TgiPeminjaman,IdKendaraan,IdCustomer,IdJaminan,Biaya")] Peminjaman peminjaman)
        {
